...
[GitHub](https://github.com/spring-ai-community/spring-ai-agents) • [Docs](https://spring-ai-community.github.io/spring-ai-agents/) • [Maven](https://central.sonatype.com/repository/maven-snapshots/org/springaicommunity/agents/)
...
<img src="/images/projects/spring-ai-agents-complete-architecture.png" alt="Spring AI Agents Complete Architecture" />
...
<CardGroup cols={2}>
  ...
  <Card
    title="Context 📊"
    icon="database"
    href="https://spring-ai-community.github.io/spring-ai-agents/api/context-engineering.html"
  >
