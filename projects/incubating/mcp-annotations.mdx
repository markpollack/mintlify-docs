...
/>
<img
  src="https://img.shields.io/maven-central/v/org.springaicommunity/mcp-annotations.svg?label=Maven%20Central"
  alt="Maven Central"
/>
...
For a complete out-of-the-box experience with Spring Boot, use the [Spring AI MCP Annotation Auto-configurations](https://docs.spring.io/spring-ai/reference/1.1-SNAPSHOT/api/mcp/mcp-annotations-overview.html).

<Card
  title="Spring AI MCP Annotations Example"
  icon="leaf"
  href="https://github.com/spring-projects/spring-ai-examples/tree/main/model-context-protocol/mcp-annotations"
>
  Check out the official Spring AI example
</Card>
