...
- Maven wrapper (`./mvnw`) in your repository root
...
<Tabs>
  <Tab title="Using community-parent (recommended)">
    ...
    This gives you the full release profile automatically — `central-publishing-maven-plugin`, `maven-gpg-plugin`, `maven-source-plugin`, and `maven-javadoc-plugin` are all preconfigured.
  </Tab>
