...
<Note>
**Explicit always wins.** Setting `skip-git-check` directly always overrides the mode-derived value. See [Defaults Philosophy](/agent-client/explanation/defaults-philosophy) for the precedence rationale.
</Note>
