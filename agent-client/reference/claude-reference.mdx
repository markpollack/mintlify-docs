...
The Claude agent wraps the [Claude Code CLI](https://docs.anthropic.com/en/docs/claude-code) via `ClaudeAgentModel`. Configure it through Spring properties under `spring.ai.agents.claude-code.*`.
...
Prefix: `spring.ai.agents.claude-code`
