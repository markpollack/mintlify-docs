...
<Note>
**Explicit always wins.** If you set `agent-client.codex.skip-git-check=true` alongside `agent-client.mode=strict`, the explicit property wins. See [Defaults Philosophy](/agent-client/explanation/defaults-philosophy) for the full rationale.
</Note>
