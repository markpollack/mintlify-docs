...
Future `STRICT` mode knobs for Gemini will be added when there is a concrete safety control to gate (following the [promotion rubric](/agent-client/portable-options#promotion-rubric)).
