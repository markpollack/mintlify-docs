...
- [Switching Providers](/agent-client/switching-providers) — Run the same task with different providers
- [Structured Output](/agent-client/structured-output) — Get structured JSON responses from agents
- [Configuration Reference](/agent-client/portable-options) — All available configuration options
